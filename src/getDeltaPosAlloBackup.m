...
delta_pos_allo(1) = delta_pos_ego(1)*cos(phi_allo) - delta_pos_ego(2)*sin(phi_allo); % m
delta_pos_allo(2) = delta_pos_ego(1)*sin(phi_allo) + delta_pos_ego(2)*cos(phi_allo); % m
end